...
- **F** (IV)
- **Dm** (ii), shares D and F with F, often used in place of F especially in jazz (ii-V-I)
...
- **Reharmonize** songs by swapping chords within the same function
- **Predict** what chord comes next
- **Transpose** by thinking in functions instead of letter names
